  ...
  const services = [
    {
      ...
      features: [
        'services.features.influencerSourcing',
        'services.features.campaignManagement',
        'services.features.performanceTracking',
      ],
    },
    {
      icon: Target,
      ...
      features: [
        'services.features.halalAdPlacement',
        'services.features.audienceTargeting',
        'services.features.roiOptimization',
      ],
    },
    {
      icon: PenTool,
      ...
      features: [
        'services.features.contentStrategy',
        'services.features.creativeProduction',
        'services.features.communityManagement',
      ],
    },
    {
      icon: TrendingUp,
      ...
      features: [
        'services.features.marketResearch',
        'services.features.brandPositioning',
        'services.features.growthPlanning',
      ],
    },
  ]
