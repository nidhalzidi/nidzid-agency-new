...
export default function WhyChooseUs() {
  ...
  const trustIndustries = [
    t('whyUs.trustIndustries.halalFood'),
    t('whyUs.trustIndustries.islamicFinance'),
    t('whyUs.trustIndustries.modestFashion'),
    t('whyUs.trustIndustries.muslimTravel'),
    t('whyUs.trustIndustries.islamicMedia'),
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 pt-12 border-t border-white/20">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 lg:gap-16 opacity-60">
            {trustIndustries.map((industry, idx) => (
