...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  const t = (key: string): string => {
    ...
    for (const k of keys) {
      ...
      const keyToUse = String(k)
      if (value && typeof value === 'object' && keyToUse in value) {
        value = value[keyToUse]
        ...
        for (const fallbackKey of keys) {
          const fbKey = String(fallbackKey)
          if (value && typeof value === 'object' && fbKey in value) {
            value = value[fbKey]
          } else if (value && typeof value === 'object' && fallbackKey in value) {
